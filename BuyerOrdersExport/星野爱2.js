...
if (orderListPage.exec(document.URL)) {
    ...
    const userMainListRowInput = document.createElement("li");
    const userMainListRowDate = document.createElement("li");
    ...
    userMainListRowInput.id = "userMainListRowInput";
    userMainListRowDate.id = "userMainListRowDate";
    ...
    userMainList.appendChild(userMainListRowInput);
    userMainList.appendChild(userMainListRowDate);
    ...
    userMainListRowInput.appendChild(excludeOrdersInput);
    ...
    userMainListRowDate.appendChild(dateRangeDiv);
...
function setElementStyle() {
    ...
    const userMainListRowInput = document.getElementById("userMainListRowInput");
    const userMainListRowDate = document.getElementById("userMainListRowDate");
    ...
    userMainListRowInput.style.marginTop = "20px"; // 调整输入框位置
    userMainListRowDate.style.marginTop = "20px";  // 调整时间选择器位置
